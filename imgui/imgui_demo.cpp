...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            ImGui::InputText("input text", str0, IM_ARRAYSIZE(str0), true);
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Filtered Text Input"))
        {
            ...
            static char buf6[32] = ""; ImGui::InputText("casing swap", buf6, 32, ImGuiInputTextFlags_CallbackCharFilter, true, TextFilters::FilterCasingSwap); // Use CharFilter callback to replace characters.
            static char buf7[32] = ""; ImGui::InputText("\"imgui\"",   buf7, 32, ImGuiInputTextFlags_CallbackCharFilter, true, TextFilters::FilterImGuiLetters); // Use CharFilter callback to disable some characters.
            ImGui::TreePop();
        }
        ...
        if (ImGui::TreeNode("Completion, History, Edit Callbacks"))
        {
            ...
            static char buf1[64];
            ImGui::InputText("Completion", buf1, 64, true, ImGuiInputTextFlags_CallbackCompletion, Funcs::MyCallback);
            ...
            static char buf2[64];
            ImGui::InputText("History", buf2, 64, true, ImGuiInputTextFlags_CallbackHistory, Funcs::MyCallback);
            ...
            ImGui::InputText("Edit", buf3, 64, true, ImGuiInputTextFlags_CallbackEdit, Funcs::MyCallback, (void*)&edit_count);
        ...
        if (ImGui::TreeNode("Miscellaneous"))
        {
            ...
            ImGui::InputText("Hello", buf1, IM_ARRAYSIZE(buf1), true, flags);
            ImGui::TreePop();
        }
    ...
    if (ImGui::TreeNode("Querying Item Status (Edited/Active/Hovered etc.)"))
    {
        ...
        char buf[1] = "";
        ImGui::InputText("unused", buf, IM_ARRAYSIZE(buf), true, ImGuiInputTextFlags_ReadOnly);
        ImGui::SameLine();
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::InputText("Input", InputBuf, IM_ARRAYSIZE(InputBuf), true, input_text_flags, &TextEditCallbackStub, (void*)this))
        {
            char* s = InputBuf;
            Strtrim(s);
            if (s[0])
